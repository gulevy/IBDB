...
insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Pride and Prejudice' ,1 , 'PrideandPrejudice.png' , 1,'1813-01-28', 'T. Egerton, Whitehall' , 'The story is based on Jane Austens novel about five sisters - Jane, Elizabeth, Mary, Kitty and Lydia Bennet - in Georgian England. Their lives are turned upside down when a wealthy young man (Mr. Bingley) and his best friend (Mr. Darcy) arrive in their neighborhood',10);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('All My Sons' , 3 , 'all_my_sons.png' , 1,'1947-01-29', 'allright' , 'Joe Keller and Herbert Deever, partners in a machine shop during the war, turned out defective airplane parts, causing the deaths of many men. Deever was sent to prison while Keller escaped punishment and went on to make a lot of money. In a work of tremendous power, a love affair between Kellers son, Chris, and Ann Deever, Herberts daughter, the bitterness of George Keller, who returns from the war to find his father in prison and his fathers partner free, and the reaction of a son to his fathers guilt escalate toward a climax of electrifying intensity.', 9.5);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Don Quixote' , 5 , 'don_q.png' , 1,'1605-02-01', 'Francisco de Robles' , 'Alonso Quixano, a retired country gentleman in his fifties, lives in an unnamed section of La Mancha with his niece and a housekeeper. He has become obsessed with books of chivalry, and believes their every word to be true, despite the fact that many of the events in them are clearly impossible. Quixano eventually appears to other people to have lost his mind from little sleep and food and because of so much reading.',10);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Gullivers Travels' , 5 , 'guliver.png' , 32,'1726-10-28', 'Benjamin Motte' , 'From the preeminent prose satirist in the English language, a great classic recounting the four remarkable journeys of ship s surgeon Lemuel Gulliver. For children it remains an enchanting fantasy; for adults, a witty parody of political life in Swift s time and a scathing send-up of manners and morals in 18th-century England.',7.5);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Harry Potter and the Sorcerers Stone' , 2 , 'Poter1.png' , 32, '1997-06-26','Bloomsbury' , 'escued from the outrageous neglect of his aunt and uncle, a young boy with a great destiny proves his worth while attending Hogwarts School of Witchcraft and Wizardry.',4.5);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Harry Potter and the Chamber of Secrets' , 2 , 'Poter2.png' , 32, '1998-07-02','Bloomsbury' , 'Harry ignores warnings not to return to Hogwarts, only to find the school plagued by a series of mysterious attacks and a strange voice haunting him.',5);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Harry Potter and the Prisoner of Azkaban' , 2 , 'Poter3.png' , 32, '1999-07-08','Bloomsbury' , 'Its Harrys third year at Hogwarts; not only does he have a new "Defense Against the Dark Arts" teacher, but there is also trouble brewing. Convicted murderer Sirius Black has escaped the Wizards Prison and is coming after Harry.',10);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Harry Potter and the Goblet of Fire' , 2 , 'Poter4.png' , 32, '2000-07-08','Bloomsbury' , 'Harry finds himself mysteriously selected as an under-aged competitor in a dangerous tournament between three schools of magic.',6);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Shantaram' , 6 , 'Shantaram.png' , 1, '2003-07-08','Scribe Publications' , 'A convicted Australian bank robber and heroin addict who escaped from Pentridge Prison flees to India. The novel is commended by many for its vivid portrayal of tumultuous life in Bombay',7.5);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('A Long Way Gone' , 7 , 'Long.png' , 4, '2007-02-13','Farrar, Straus and Giroux' , 'The book is a firsthand account of Beahs time as a child soldier during the civil war in Sierra Leone',0);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('Fear and Loathing in Las Vegas' , 8 , 'Fear.png' , 4, '1971-11-11','Random House' , 'Fear and Loathing in Las Vegas is the best chronicle of drug-soaked, addle-brained, rollicking good times ever committed to the printed page.  It is also the tale of a long weekend road trip that has gone down in the annals of American pop culture as one of the strangest journeys ever undertaken.',0);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('The Giver' , 9 , 'Giver.png' , 2, '1993-02-11','Houghton Mifflin' , 'In a seemingly perfect community, without war, pain, suffering, differences or choice, a young boy is chosen to learn from an elderly man about the true pain and pleasure of the "real" world.',0);

insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract,rate) values ('The Hunger Games' , 10 , 'Hunger.png' , 1, '2008-06-01','	Scholastic' , 'Katniss Everdeen voluntarily takes her younger sisters place in the Hunger Games, a televised competition in which two teenagers from each of the twelve Districts of Panem are chosen at random to fight to the death.',0);
...
insert into proposals(book_id,user_id) values (1,1 );
insert into proposals(book_id,user_id) values (2,3 );
insert into proposals(book_id,user_id) values (3,2);
insert into proposals(book_id,user_id) values (4,4);
insert into proposals(book_id,user_id) values (5,5);
insert into proposals(book_id,user_id) values (6,2);
insert into proposals(book_id,user_id) values (7,1);
insert into proposals(book_id,user_id) values (8,9);
insert into proposals(book_id,user_id) values (9,3);
insert into proposals(book_id,user_id) values (10,2);
insert into proposals(book_id,user_id) values (11,1);
insert into proposals(book_id,user_id) values (12,1);
insert into proposals(book_id,user_id) values (13,2);


insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (1,'17/03/2016','pending' ,'');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (1,'18/03/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (2,'18/04/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (3,'1/05/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (4,'7/03/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (5,'2/04/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (6,'3/05/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (7,'30/03/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (8, '28/04/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (9,'6/05/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (10, '23/05/2016','approved' ,'good');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (11,'27/03/2016','denied' ,'incorrect detail');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (12, '3/02/2016','denied' ,'duplicate book');
insert into proposal_states(proposal_id ,proposal_date,proposal_status,comment) values (13, '25/01/2016','denied' , 'please fix abstract');
