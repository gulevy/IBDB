...
insert into books(name,author_id,image_name,category_id,release_date,publisher_name,book_abstract) values ('Shantaram' , 1 , 'shantaram.png' , 1,'1990-02-01', 'allright' , 'fdfdjfdjfjdjfdjf');
insert into books(name,author_id,image_name,category_id,release_date,publisher_name,book_abstract) values ('All My Sons' , 2 , 'all_my_sons.png' , 1,'1990-02-01', 'allright' , 'fdfdjfdjfjdjfdjf');
insert into books(name,author_id,image_name,category_id,release_date,publisher_name,book_abstract) values ('toy story' , 3 , 'toy_story.png' , 2, '1990-02-01','allright' , 'fdfdjfdjfjdjfdjf');
insert into books(name,author_id,image_name,category_id,release_date,publisher_name,book_abstract) values ('pinokyo' , 3 , 'dog.png' , 3, '1990-02-01','allright' , 'fdfdjfdjfjdjfdjf');
