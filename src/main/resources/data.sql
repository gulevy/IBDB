...
insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract) values ('Shantaram' ,2 , 'shantaram.png' , 1,'1990-02-01', 'allright' , 'fdfdjfdjfjdjfdjf');
...
insert into books(name,author_id,image_name,book_category_id,release_date,publisher_name,book_abstract) values ('toy story' , 2 , 'toy_story.png' , 2, '1990-02-01','allright' , 'fdfdjfdjfjdjfdjf');
